...
export const create = ({ bodymen: { body: { email, link } } }, res, next) =>
  User.findOne({ email })
    ...
    .then((reset) => {
      ...
      const content = `
        Hey, ${user.name}.<br><br>
        You requested a new password for your Machiavelli 1750 Api account.<br>
        ...
        &mdash; Machiavelli 1750 Api Team
      `
      return sendMail({ toEmail: email, subject: 'Machiavelli 1750 Api - Password Reset', content })
    })
